...
time th train.lua -data $WMT_DATASET_PATH/wmt15-de-en/wmt15-all-en-de-train.t7 -save_model $WMT_DATASET_PATH/wmt15-de-en/wmt15-all-en-de -gpuid 1 2 3 4 5 6 7 8 -end_epoch 1
